...
When I used to use Gitlab pages for hosting my website and my knowledge about DNS was effectively non-existant,
I used a CNAME record to point my website to my Gitlab pages site.
This of course didn't work, but thankfully a nice person in the forums explained that I can't use a CNAME record
...
to immediately redirect all the subdomains to a new location.
