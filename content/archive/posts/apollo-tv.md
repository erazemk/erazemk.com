...
(although you can choose which video player you want).
...
Download Node.js from their website into the */tmp* dir using
...
(replace the filename with your appropriate Node.js archive).
Copy the contents of the Node.js' extracted folder into */usr/local* with
