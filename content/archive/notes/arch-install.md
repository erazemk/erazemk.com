...
*\* To get the $disk-uuid use `:read ! blkid /dev/sda2` inside neovim.*
...
Add an [Adguard DNS](https://adguard.com/en/adguard-dns/overview.html#instruction)
entry to the WiFi config file: `nvim /var/lib/iwd/<wifi-name>.psk`:
